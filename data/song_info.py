...
def fetch_and_save_urls(input_file, output_directory):
    ...
    for url in urls:
        ...
        if response.status_code == 200:
            ...
            # 生成保存文件的路径
            song_id = url.split('/')[-1]
            output_file = f'{output_directory}/{song_id}.html'
...
input_file = 'song_urls1.txt'
output_directory = 'song_info1'
if not os.path.exists(output_directory):
    os.makedirs(output_directory)
fetch_and_save_urls(input_file, output_directory)

input_file = 'song_urls2.txt'
output_directory = 'song_info2'
if not os.path.exists(output_directory):
    os.makedirs(output_directory)
fetch_and_save_urls(input_file, output_directory)

input_file = 'song_urls3.txt'
output_directory = 'song_info3'
if not os.path.exists(output_directory):
    os.makedirs(output_directory)
fetch_and_save_urls(input_file, output_directory)

input_file = 'song_urls4.txt'
output_directory = 'song_info4'
if not os.path.exists(output_directory):
    os.makedirs(output_directory)
fetch_and_save_urls(input_file, output_directory)

input_file = 'song_urls5.txt'
output_directory = 'song_info5'
if not os.path.exists(output_directory):
    os.makedirs(output_directory)
fetch_and_save_urls(input_file, output_directory)